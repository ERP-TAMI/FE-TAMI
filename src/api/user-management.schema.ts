...
export const accountLockEmailStatusSchema = z.enum(["pending", "sent", "failed"]);
...
export const userListItemSchema = z.object({
  ...
  accountLockEmailStatus: accountLockEmailStatusSchema.nullable().optional().default(null),
});
